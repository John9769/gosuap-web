    ...
    <main className="bg-[#0a1100] min-h-screen font-sans overflow-x-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-8 pt-16 pb-16">
          ...
          <div className="flex-1">
            ...
            <p className="fade-up-3 font-nunito text-gray-400 text-base leading-relaxed mb-8 max-w-md">
              Direktori digital untuk peniaga makanan Muslim Malaysia. GPS-based discovery, menu showcase, navigasi terus via Waze.
            </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { icon: "📍", title: "GPS Discovery", desc: "Kedai terdekat muncul dulu. Premium kedai di bahagian atas. Disusun mengikut jarak dari lokasi anda.", accent: "#b8e030" },
            ...
            { icon: "🧾", title: "Top 5 Menu", desc: "Setiap kedai paparkan 5 menu terbaik dengan gambar dan harga. Tahu apa nak order sebelum tiba.", accent: "#d4f040" },
            ...
            { icon: "🗺️", title: "Waze Navigate", desc: "Satu klik terus navigasi ke kedai. Tak perlu salin alamat lagi.", accent: "#90c828" },
            { icon: "⭐", title: "Premium Boost", desc: "Kedai premium muncul pertama sekali. Lebih keterlihatan, lebih pelanggan.", accent: "#d4f040" },
          ].map((f) => (
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { step: "03", icon: "📍", title: "Navigasi & Makan", desc: "Klik Navigate, Waze bawa anda terus ke pintu kedai." },
            ].map((s) => (
      ...
      <footer className="border-t border-[#1c2e00] px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-4">
          <img src="/logo.png" alt="GoSuap" className="h-16 w-auto object-contain opacity-60" style={{mixBlendMode:'multiply'}} />
          ...
          <div className="flex gap-6 items-center flex-wrap justify-center">
            <Link href="/privacy">
              <span className="font-nunito text-[11px] text-gray-600 font-black uppercase tracking-widest hover:text-[#b8e030] transition cursor-pointer">
                Dasar Privasi
              </span>
            </Link>
